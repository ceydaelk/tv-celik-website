  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="mb-10 text-base font-normal leading-relaxed text-white/50">
          {description}
        </p>
        <a
          ...
          className="inline-flex items-center gap-3 rounded-full border border-[#25D366]/50 px-10 py-4 text-base font-bold tracking-wide text-[#25D366] backdrop-blur-sm transition-all duration-300 ease-out hover:bg-[#25D366] hover:border-[#25D366] hover:text-white hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-[#25D366]/25 active:scale-[0.97] focus:outline-2 focus:outline-[#25D366]"
